...
namespace E2B
{
    public partial class SandboxesClient
    {
        ...
        private static readonly global::E2B.EndPointSecurityRequirement s_CreateSandboxesBySandboxIDConnect2SecurityRequirement0 =
        ...
        private static readonly global::E2B.EndPointSecurityRequirement[] s_CreateSandboxesBySandboxIDConnect2SecurityRequirements =
            new global::E2B.EndPointSecurityRequirement[]
            {                s_CreateSandboxesBySandboxIDConnect2SecurityRequirement0,
            };
        partial void PrepareCreateSandboxesBySandboxIDConnect2Arguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string sandboxID,
            global::E2B.ConnectSandboxV2 request);
        partial void PrepareCreateSandboxesBySandboxIDConnect2Request(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string sandboxID,
            global::E2B.ConnectSandboxV2 request);
        partial void ProcessCreateSandboxesBySandboxIDConnect2Response(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateSandboxesBySandboxIDConnect2ResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::E2B.Sandbox> CreateSandboxesBySandboxIDConnect2Async(
            string sandboxID,
        ...
        {
            var __response = await CreateSandboxesBySandboxIDConnect2AsResponseAsync(
                sandboxID: sandboxID,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::E2B.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::E2B.AutoSDKHttpResponse<global::E2B.Sandbox>> CreateSandboxesBySandboxIDConnect2AsResponseAsync(
            string sandboxID,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateSandboxesBySandboxIDConnect2Arguments(
            ...
            var __authorizations = global::E2B.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateSandboxesBySandboxIDConnect2SecurityRequirements,
                operationName: "CreateSandboxesBySandboxIDConnect2Async");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateSandboxesBySandboxIDConnect2Request(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::E2B.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::E2B.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "createSandboxesBySandboxIDConnect2",
                                methodName: "CreateSandboxesBySandboxIDConnect2Async",
                                pathTemplate: "$\"/v2/sandboxes/{sandboxID}/connect\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateSandboxesBySandboxIDConnect2Response(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::E2B.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateSandboxesBySandboxIDConnect2ResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::E2B.Sandbox.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::E2B.AutoSDKHttpResponse<global::E2B.Sandbox>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::E2B.Sandbox.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::E2B.Sandbox> CreateSandboxesBySandboxIDConnect2Async(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::E2B.ConnectSandboxV2
            {
                Timeout = timeout,
                Memory = memory,
            };

            return await CreateSandboxesBySandboxIDConnect2Async(
                sandboxID: sandboxID,
                request: __request,
                requestOptions: requestOptions,
