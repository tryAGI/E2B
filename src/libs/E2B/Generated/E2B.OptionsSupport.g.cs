...
namespace E2B
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::E2B.AutoSDKRetryOptions Retry { get; set; } = new global::E2B.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::E2B.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::E2B.IAutoSDKHook>();
        ...
        public global::E2B.AutoSDKClientOptions AddHook(
            global::E2B.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::E2B.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::E2B.AutoSDKClientOptions UseAuthorizationProvider(
            global::E2B.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::E2B.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::E2B.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::E2B.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::E2B.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::E2B.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::E2B.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::E2B.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::E2B.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::E2B.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::E2B.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::E2B.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::E2B.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::E2B.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::E2B.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::E2B.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::E2B.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::E2B.AutoSDKClientOptions clientOptions,
            global::E2B.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::E2B.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::E2B.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::E2B.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::E2B.AutoSDKClientOptions clientOptions,
            global::System.Func<global::E2B.IAutoSDKHook, global::E2B.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::E2B.AutoSDKHookContext context)
        {
