...
namespace E2B
{
    public partial class SecretsClient
    {
        ...
        private static readonly global::E2B.EndPointSecurityRequirement s_CreateSecretsBySecretIDSecurityRequirement0 =
        ...
        private static readonly global::E2B.EndPointSecurityRequirement[] s_CreateSecretsBySecretIDSecurityRequirements =
            new global::E2B.EndPointSecurityRequirement[]
            {                s_CreateSecretsBySecretIDSecurityRequirement0,
            };
        partial void PrepareCreateSecretsBySecretIDArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string secretID,
            global::E2B.SecretUpdate request);
        partial void PrepareCreateSecretsBySecretIDRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string secretID,
            global::E2B.SecretUpdate request);
        partial void ProcessCreateSecretsBySecretIDResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateSecretsBySecretIDResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::E2B.Secret> CreateSecretsBySecretIDAsync(
            string secretID,
        ...
        {
            var __response = await CreateSecretsBySecretIDAsResponseAsync(
                secretID: secretID,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::E2B.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::E2B.AutoSDKHttpResponse<global::E2B.Secret>> CreateSecretsBySecretIDAsResponseAsync(
            string secretID,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateSecretsBySecretIDArguments(
            ...
            var __authorizations = global::E2B.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateSecretsBySecretIDSecurityRequirements,
                operationName: "CreateSecretsBySecretIDAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateSecretsBySecretIDRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::E2B.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::E2B.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "createSecretsBySecretID",
                                methodName: "CreateSecretsBySecretIDAsync",
                                pathTemplate: "$\"/secrets/{secretID}\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateSecretsBySecretIDResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::E2B.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 502)
                            {
                                ...
                                global::E2B.Error? __value_502 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_502 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_502 = global::E2B.Error.FromJson(__content_502, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_502 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateSecretsBySecretIDResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::E2B.Secret.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::E2B.AutoSDKHttpResponse<global::E2B.Secret>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::E2B.Secret.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::E2B.Secret> CreateSecretsBySecretIDAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::E2B.SecretUpdate
            {
                Value = value,
                Metadata = metadata,
            };

            return await CreateSecretsBySecretIDAsync(
                secretID: secretID,
                request: __request,
                requestOptions: requestOptions,
