...
namespace E2B
{
    public partial class SandboxesClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::E2B.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::E2B.AutoSDKHttpResponse<global::E2B.SandboxLogsV2Response>> GetSandboxesBySandboxIDLogs2AsResponseAsync(
            string sandboxID,
            long? cursor = default,
            int? limit = default,
            global::E2B.LogsDirection? direction = default,
                    ...
                    await global::E2B.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::E2B.SandboxLogsV2Response.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::E2B.AutoSDKHttpResponse<global::E2B.SandboxLogsV2Response>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::E2B.SandboxLogsV2Response.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
