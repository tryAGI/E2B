                    ...
                    await global::E2B.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::E2B.SnapshotInfo.FromJson(__content, JsonSerializerContext) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::E2B.SnapshotInfo.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
