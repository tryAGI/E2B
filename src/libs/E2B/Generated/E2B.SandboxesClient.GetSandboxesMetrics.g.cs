                    ...
                    await global::E2B.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::E2B.SandboxesWithMetrics.FromJson(__content, JsonSerializerContext) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::E2B.SandboxesWithMetrics.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
